	...
	<table style="width: 4in;border:1px solid black;border-collapse: collapse;">
		<tr>
			<td align="center" style="line-height: 5mm; padding:.5rem">
				...
				<small>BLOOD DONATION CARD</small> <br>
		...
		<tr>
			<td style="width:2.5in; padding:.5rem" align="left">
				...
				<br><br>
				<span><strong>Blood Type: <strong><?php echo strtoupper($email) ?></span> <br>
				<span><strong>Contact /Email: </strong><?php echo strtoupper($contact) ?></span> <br>
