		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT p.*,z.name as zname,c.name as zname,c.name as cname, s.name as sname FROM establishment p inner join barangay_list z on z.id = p.zone_id inner join city_list c on c. id= z.city_id inner join state_list s on s.id = c.state_id order by z.name asc ");
					...
					<tr>
						...
						<td><b class="text-center">Blood type: <?php echo ucwords($row['address']) ?></b></td>
