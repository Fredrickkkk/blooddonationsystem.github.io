...
$ad= $conn->query("SELECT * FROM barangay_list where id = $zone_id ")->fetch_array()['name'];
...
<div class="col-md-12">
	...
	<dl>
		<dt>Blood Type</dt>
		<dd><?php echo strtoupper($address) ?></dd>
	</dl>
	<dl>
		<dt>Address</dt>
		<dd><b class="text-center">PROVINCE OF: <?php echo strtoupper($state.', '.$city.' City, '.$zone) ?></dd>
	</dl>
</div>
<script>
