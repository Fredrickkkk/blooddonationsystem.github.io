...
<form action="" id="establishment-frm">
	...
	<div class="form-group">
		<label for="address" class="control-label">Blood</label>
		<option type="text" class="form-control form-control-sm" name="address" id="address" required ><?php echo isset($address) ? $address : '' ?></option>
	</div>
	<div class="form-group">
